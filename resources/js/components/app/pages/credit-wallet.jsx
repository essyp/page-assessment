                            ...
                            <form id="credit-form">
                                <div className="row">
                                    <div className="col-lg-12">
                                        <h4 className="mb-4 font-xs fw-700 mont-font mt-3">Credit Wallet</h4>
                                    </div>
                                    <div className="col-lg-12 mb-3">
                                        <div className="form-gorup">
                                            <label className="mont-font fw-600 font-xssss">Wallet Account No</label>
                                ...
                                <div className="row">
                                    ...
                                    <input type="hidden" name="wallet_id" value={this.state.user.wallet ? this.state.user.wallet.id : ''} className="form-control"/>
                                        <button type="button" onClick={this.creditWallet} className="bg-current text-center text-white font-xsss fw-600 p-3 w175 rounded-lg d-inline-block">Proceed</button>
                                    </div>
                                </div>
